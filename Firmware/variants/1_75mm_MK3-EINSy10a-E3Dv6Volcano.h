...
#define NOZZLE_TYPE "E3Dv6Volcano"
...
#define E3D_PT100_EXTRUDER_WITH_AMP // JTa
...
#define HOMING_FEEDRATE {HOMING_FEEDRATE_X, HOMING_FEEDRATE_Y, 800, 0}  // use feedrates for reliable X AND Y 0.9 degree motor stallGuard
